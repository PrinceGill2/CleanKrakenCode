...
public class LimelightHelpers {
    ...
    public static class LimelightTarget_Fiducial {
        ...
        public Pose3d getCameraPose_TargetSpace() //This gets the Pose of the april tag? these are notes of me trying to figure it out
        {
            return toPose3D(cameraPose_TargetSpace);
        }

        public Pose3d getRobotPose_FieldSpace() //This will get the pose of the robot in the field?
        {
            return toPose3D(robotPose_FieldSpace);
        }
     ...
     * (Programmers Note: I assume this means the robot is treated as 0,0 and the 
     *  coordinate within Pose3d would have a magnitude and direction with origin
     *  to the robot in a cartesian coordinate system)
     * @param limelightName Name/identifier of the Limelight
